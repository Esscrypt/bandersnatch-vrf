...
pub use crate::batch::vendored::piop::{params::PiopParams, FixedColumnsCommitted, ProverKey, VerifierKey};
use crate::batch::vendored::piop::{RingCommitments, RingEvaluations};
...
mod tests {
    ...
    use crate::batch::vendored::piop::FixedColumnsCommitted;
    use crate::batch::vendored::ring::{Ring, RingBuilderKey};
    use crate::batch::vendored::ring_prover::RingProver;
    use crate::batch::vendored::ring_verifier::RingVerifier;
